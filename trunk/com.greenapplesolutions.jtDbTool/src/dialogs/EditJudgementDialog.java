...
public class EditJudgementDialog extends Dialog {
	...
	private void createContents() {
		...
		text_22 = new Text(composite, SWT.BORDER | SWT.WRAP | SWT.V_SCROLL | SWT.MULTI);
		...
		grpCitation_2.setBounds(10, 188, 405, 82);
		...
		grpCitation_3.setBounds(10, 280, 405, 82);
		...
		grpCitation_4.setBounds(10, 368, 405, 82);
		...
		grpCitation_5.setBounds(10, 456, 405, 82);
		...
		text_23 = new Text(grpHeadnoteAndHeld, SWT.BORDER | SWT.WRAP | SWT.V_SCROLL | SWT.MULTI);
		text_23.setBounds(10, 42, 418, 80);
		
		text_24 = new Text(grpHeadnoteAndHeld, SWT.BORDER | SWT.WRAP | SWT.V_SCROLL | SWT.MULTI);
		...
		text_25 = new Text(group, SWT.BORDER | SWT.WRAP | SWT.V_SCROLL | SWT.MULTI);
		text_25.setBounds(10, 42, 418, 80);
		
		text_26 = new Text(group, SWT.BORDER | SWT.WRAP | SWT.V_SCROLL | SWT.MULTI);
		...
		text_27 = new Text(group_1, SWT.BORDER | SWT.WRAP | SWT.V_SCROLL | SWT.MULTI);
		text_27.setBounds(10, 42, 418, 80);
		
		text_28 = new Text(group_1, SWT.BORDER | SWT.WRAP | SWT.V_SCROLL | SWT.MULTI);
		...
		text_29 = new Text(group_2, SWT.BORDER | SWT.WRAP | SWT.V_SCROLL | SWT.MULTI);
		text_29.setBounds(10, 42, 418, 80);
		
		text_30 = new Text(group_2, SWT.BORDER | SWT.WRAP | SWT.V_SCROLL | SWT.MULTI);
