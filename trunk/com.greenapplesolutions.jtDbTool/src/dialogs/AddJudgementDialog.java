...
import modelProvider.AddJudgementdialogModelProvider;
...
public class AddJudgementDialog extends Dialog {
	...
	private AddJudgementdialogModelProvider modelProvider;
	private Combo combo;
	 ...
	 * @param style
	 */
	public AddJudgementDialog(Shell parent, String keycode, String courtName) {
		super(parent);
		modelProvider = new AddJudgementdialogModelProvider(keycode, courtName);
		setText("SWT Dialog");
	}
	...
	private void createContents() {
		...
		btnUpdate.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				if (modelProvider.insertJudgement())
					shlVieweditJudgement.close();
				else
