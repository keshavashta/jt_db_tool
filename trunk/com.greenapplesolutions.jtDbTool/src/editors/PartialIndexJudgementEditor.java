...
import modelProvider.PartialIndexJudgementEditorModelProvider;
...
public class PartialIndexJudgementEditor extends EditorPart {
	private DataBindingContext m_bindingContext;
	public static final String ID = "com.greenapplesolutions.jtDbTool.partialIndexEditor";
	private Text text;
	private PartialIndexJudgementEditorModelProvider modelProvider;

	public PartialIndexJudgementEditor() {
		setTitleImage(ResourceManager.getPluginImage("com.greenapplesolutions.jtDbTool", "icons/appIcons/1349639881_Database_1.png"));
	...
	public void init(IEditorSite site, IEditorInput input)
		...
		modelProvider = new PartialIndexJudgementEditorModelProvider();
	}
	...
	public void createPartControl(Composite parent) {
		...
		btnIndex.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				modelProvider.indexPartialJudgements();
			}
		});
		...
		fd_label_1.left = new FormAttachment(composite, 0, SWT.LEFT);
		...
		FormData fd_lblFromDate = new FormData();
		fd_lblFromDate.left = new FormAttachment(0, 10);
		lblFromDate.setLayoutData(fd_lblFromDate);
		lblFromDate.setText("From Date");
		
		DateTime dateTime = new DateTime(parent, SWT.BORDER | SWT.DROP_DOWN);
		fd_composite.top = new FormAttachment(dateTime, 6);
		fd_lblFromDate.top = new FormAttachment(dateTime, 0, SWT.TOP);
		FormData fd_dateTime = new FormData();
		fd_dateTime.left = new FormAttachment(lblFromDate, 21);
		fd_dateTime.top = new FormAttachment(text, 12);
