...
public class AddJudgementdialogModelProvider {
	private List<String> journals;
	private String courtName;

	public AddJudgementdialogModelProvider(String keycode, String courtName) {
	...
	public boolean insertJudgement() {
		...
		judgement.CreatedDate = new Date();
